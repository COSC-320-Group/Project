...
public class TwitterCon {
	...
	public static void main(String[] args) throws ParseException, IOException {
		String path = "/Users/Hassan/Desktop/Slang.csv";
	    String line =  null;
	    long startTime;
		long endTime;
    ...
    public static String Replace(String tweet) {
        ...
        for(int i = 0; i < tweetSubstring.length; i++) {
            if (map.containsKey(remove(tweetSubstring[i].toLowerCase()))) {                // if a substring is an abbreviation
                tweetSubstring[i] = map.get(tweetSubstring[i]); //checking words to see if there is a key value replacement
                changes++;
            }  
        }
